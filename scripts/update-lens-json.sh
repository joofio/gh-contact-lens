...
# Script to encode contact-lens.js to base64 and update contact-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/contact-lens.js"
JSON_FILE="$PROJECT_DIR/contact-lens.json"
...
console.log('✅ Updated contact-lens.json with encoded JS');
"
